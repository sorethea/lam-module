...
use Modules\LAM\Support\Config\GenerateConfigReader;
...
class ModuleGenerator extends Generator
{
    ...
    public function generate(): int
    {
        ...
        $this->installer->setInstalledByName($name, $this->isInstalled);
    ...
    public function generateResources()
    {
        ...
        if (GenerateConfigReader::read('provider')->generate() === true) {
            $this->console->call('lam:provider', [
            ...
            $this->console->call('lam:auth-provider', [
                'module' => $this->getName(),
            ]);
